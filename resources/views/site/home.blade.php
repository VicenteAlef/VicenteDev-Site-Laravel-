...
<section class="relative w-full h-screen flex justify-end items-center px-[5%] md:px-[10%] text-white overflow-hidden">
    ...
    <div class="reveal w-full flex flex-col items-end z-10">
        ...
        <div class="grid sm:grid-cols-2 gap-5 mt-8 w-full max-w-lg justify-items-end">
            <div class="flex gap-5 w-full justify-end  items-center">
                <a href="https://www.youtube.com/@VicenteDeveloper" title="YouTube" target="_blank" class="hover:text-red-500 hover:scale-110 transition-all">
                ...
                <a href="https://github.com/VicenteAlef" title="GitHub" target="_blank" class="hover:text-gray-400 hover:scale-110 transition-all">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" viewBox="0 0 16 16">
                        <path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27s1.36.09 2 .27c1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.01 8.01 0 0 0 16 8c0-4.42-3.58-8-8-8" />
                    </svg>
                </a>
                <a href="https://www.linkedin.com/in/vicente-da-silva-57a0a1341" title="LinkedIn" target="_blank" class="hover:text-blue-500 hover:scale-110 transition-all">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" viewBox="0 0 16 16">
            ...
            <a href="{{ asset('assets/CurriculoVicente.pdf') }}" download="Curriculo_Vicente_Silva.pdf" class="flex items-center justify-center gap-2 bg-blue-500 hover:bg-blue-600 px-5 py-3 rounded-xl transition-colors font-semibold max-w-50">
                Baixar Currículo
            ...
            <div class="relative w-full overflow-hidden rounded-xl bg-gray-900/50 p-2 border border-gray-800" id="carousel-container">
                ...
                <div class="flex transition-transform duration-500 ease-in-out" id="carousel-track">
                    ...
                    <div class="w-full flex-shrink-0 px-2 lg:px-4">
                        <div class="grid grid-cols-1 lg:grid-cols-1 gap-6 items-center max-w-170 mx-auto">
