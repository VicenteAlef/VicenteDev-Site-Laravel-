...
<body class="bg-[#0a0d11] text-white font-sans antialiased overflow-x-hidden">
    ...
    <header class="flex items-center justify-between px-4 lg:px-[10%] py-2 bg-[#0a0d11]/95 backdrop-blur-sm text-white fixed z-50 w-full border-b border-gray-800/50">
        ...
        <nav id="navMenu" class="absolute top-full left-0 w-full bg-[#0c0f13] md:bg-transparent z-50 md:static md:block md:w-auto transition-all duration-300 hidden md:flex border-b md:border-none border-gray-800">
            <ul class="flex flex-col md:flex-row md:gap-6 p-4 md:p-0 font-bold">
                ...
                <li>
                    <a href="{{ request()->routeIs('site.home') ? '#projects' : route('site.home').'#projects' }}" class="block py-2 px-4 hover:bg-blue-950/50 rounded md:hover:bg-transparent md:hover:text-blue-400 transition-colors">Destaques</a>
                </li>
                <li>
    ...
    <footer class="w-full h-24 bg-black text-gray-400 flex items-center justify-center border-t border-gray-900">
